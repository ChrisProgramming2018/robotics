...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        ### Your FK code here
        # Create symbols
        d1, d2, d3, d4, d5, d6, d7 = symbols('d1:8')  #  offset
        a0, a1, a2, a3, a4, a5, a6 = symbols('a0:7')  #   length
	...
	r, p , y = symbols('r p y')
        ...
        for x in xrange(0, len(req.poses)):
            start_time = time()
            rospy.loginfo("Start episodes %s " % x)
            # IK code starts here
	    ...
	    joint_trajectory_list.append(joint_trajectory_point)
            rospy.loginfo("End episode %s after %s " % x, start_time - time())
